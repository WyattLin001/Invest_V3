...
private let faqData: [FAQItem] = [
    ...
    FAQItem(
        question: "什麼是股圈？",
        answer: "股圈是基於行為金融學理論設計的投資教育平台，採用以下學術框架：\n\n📚 理論基礎：\n• 行為金融學 - 分析投資者認知偏誤\n• 投資組合理論 - 風險分散與資產配置\n• 市場效率假說 - 透明資訊傳遞機制\n• 社會學習理論 - 專家知識傳承模式\n\n🔬 平台特色：\n• 透明化交易記錄與績效追蹤\n• 同儕學習與專家指導結合\n• 模擬交易環境降低實際損失風險\n• 多元化資訊來源避免群體迷思\n\n🎯 研究目標：透過結構化學習環境，提升散戶投資者的金融素養與決策品質。",
        category: .popular
    ),
    FAQItem(
        question: "如何開始使用股圈？",
    ...
    FAQItem(
        question: "投資組合數據的更新頻率與數據品質如何？",
        answer: "📊 數據更新機制：\n• 更新頻率：即時更新（≤1秒延遲）\n• 數據來源：認證金融數據供應商（Thomson Reuters, Bloomberg等）\n• 計算方法：採用標準化投資組合評價模型\n\n🔬 績效分析指標：\n• 夏普比率（Sharpe Ratio）- 風險調整後報酬\n• 最大回撤（Maximum Drawdown）- 風險控制指標\n• 貝他係數（Beta）- 系統性風險測量\n• 阿爾法值（Alpha）- 超額報酬能力\n\n📈 統計學意義：所有績效指標均通過統計顯著性檢定，確保數據的可靠性與學術研究價值。",
        category: .popular
    ),
    FAQItem(
        question: "如何參加投資錦標賽？",
    ...
    FAQItem(
        ...
        answer: "歡迎加入投資世界！建議您：\n1. 先完成新手教學課程\n2. 瀏覽專家的資訊文章和分析\n3. 查看不同類型專家的投資策略\n4. 用虛擬資金開始模擬投資\n5. 關注適合新手的投資專家\n6. 參加新手友善的錦標賽\n我們的專家分類系統確保資訊平衡分配，讓您接觸到多元化的投資觀點。",
        category: .quickStart
    ),
    FAQItem(
        question: "如何註冊帳號？",
    ...
    FAQItem(
        ...
        answer: "我們的專家按投資類型分類，確保資訊平衡分配：\n\n📊 專家分類：\n• 價值投資專家 - 長期穩健策略\n• 成長股專家 - 高成長潛力標的\n• 技術分析專家 - 圖表趨勢分析\n• 存股達人 - 穩定配息策略\n• 新手友善專家 - 基礎教學導向\n\n🎯 平衡資訊目的：\n• 避免單一觀點偏見\n• 提供多元投資策略\n• 讓每位用戶接觸不同風格\n• 培養獨立思考能力\n\n建議新手先從「新手友善」標籤專家開始，再逐步了解其他類型專家的策略。",
        category: .quickStart
    ),
    ...
    // 社群互動
    FAQItem(
        question: "什麼是專家分類系統？為什麼要平衡分配資訊？",
        answer: "🎯 股圈的專家分類系統旨在提供平衡、多元化的投資資訊：\n\n📋 分類標準：\n• 投資策略類型（價值投資、成長股、技術分析等）\n• 風險偏好程度（保守、平衡、積極）\n• 教學友善度（新手友善、進階投資者）\n• 專業領域（台股、美股、ETF、加密貨幣等）\n\n🔄 平衡資訊的重要性：\n• 防止資訊繭房效應\n• 避免單一策略風險\n• 提供完整投資視角\n• 培養批判思維能力\n• 適應不同市場環境\n\n💡 系統會根據您的關注偏好，主動推薦其他類型的專家文章，確保您接收到均衡的投資觀點。",
        category: .social
    ),
    FAQItem(
        question: "如何關注投資專家？",
    ...
    // MARK: - 學術研究支援
    FAQItem(
        question: "股圈平台是否支持學術研究？如何獲取研究數據？",
        answer: "🎓 學術研究支援框架：\n\n📚 研究數據類型：\n• 匿名化用戶行為數據\n• 投資決策路徑分析\n• 群體投資心理指標\n• 專家影響力傳播模式\n• 風險偏好變化趨勢\n\n🔬 研究方法論支援：\n• 實驗組與對照組設計\n• 長期追蹤研究數據\n• A/B測試框架支援\n• 統計顯著性檢定工具\n\n📊 數據申請流程：\n1. 提交研究計畫書與IRB核准\n2. 簽署數據使用協議\n3. 通過學術倫理審查\n4. 獲得API訪問權限\n5. 定期提交研究進度報告\n\n🤝 合作機會：歡迎學術機構申請研究合作，共同探索數位金融教育的創新模式。",
        category: .technical
    )
]
