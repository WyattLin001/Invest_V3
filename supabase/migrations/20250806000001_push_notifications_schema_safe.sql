-- =====================================================
-- Push Notifications Database Schema (Safe Version)
-- Created: 2025-08-06
-- Modified: 2025-08-17 - Added IF NOT EXISTS for indexes
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_device_tokens_device_token') THEN
        CREATE INDEX idx_device_tokens_device_token ON device_tokens(device_token);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_device_tokens_is_active') THEN
        CREATE INDEX idx_device_tokens_is_active ON device_tokens(is_active) WHERE is_active = true;
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_device_tokens_last_used') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_templates_template_key') THEN
...
BEGIN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_user_preferences_type') THEN
        CREATE INDEX idx_user_preferences_type ON user_notification_preferences(notification_type);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_user_preferences_enabled') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_queue_user_id') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_queue_scheduled') THEN
        CREATE INDEX idx_notification_queue_scheduled ON notification_queue(scheduled_for);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_queue_priority') THEN
        CREATE INDEX idx_notification_queue_priority ON notification_queue(priority);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_queue_type') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_logs_user_id') THEN
        CREATE INDEX idx_notification_logs_user_id ON notification_logs(user_id);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_logs_type') THEN
        CREATE INDEX idx_notification_logs_type ON notification_logs(notification_type);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_logs_status') THEN
        CREATE INDEX idx_notification_logs_status ON notification_logs(delivery_status);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_logs_sent_at') THEN
        CREATE INDEX idx_notification_logs_sent_at ON notification_logs(sent_at);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_logs_queue_id') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_analytics_date') THEN
        CREATE INDEX idx_notification_analytics_date ON notification_analytics(date);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_analytics_type') THEN
        CREATE INDEX idx_notification_analytics_type ON notification_analytics(notification_type);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_notification_analytics_template') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_bulk_campaigns_status') THEN
        CREATE INDEX idx_bulk_campaigns_status ON bulk_notification_campaigns(status);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_bulk_campaigns_scheduled') THEN
        CREATE INDEX idx_bulk_campaigns_scheduled ON bulk_notification_campaigns(scheduled_for);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_bulk_campaigns_created_by') THEN
...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_rate_limits_user_type') THEN
        CREATE INDEX idx_rate_limits_user_type ON notification_rate_limits(user_id, notification_type);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM pg_indexes WHERE indexname = 'idx_rate_limits_window') THEN
...
-- =====================================================
-- INITIAL DATA - NOTIFICATION TEMPLATES (Safe Insert)
-- =====================================================
...
-- Trigger to create default preferences when a new user signs up (safe creation)
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'create_user_notification_preferences_trigger') THEN
